...
public class AggregatedSkillMapEntry extends Skill {
    ...
    public AggregatedSkillMapEntry(String entry, String cat, Set<String> versions, Period period, String industry) {
     ...
     *
     * @param object {@link AggregatedSkillMapEntry}
    ...
    public String toString() {
        return "AggregatedSkillMapEntry{" +
                "period=Y:" + period.getYears() + " M:" + period.getMonths() + " D:" + period.getDays() +
